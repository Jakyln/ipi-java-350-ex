...
/*    @Autowired
    ...
    public void embaucheEmploye(String nom, String prenom, Poste poste, NiveauEtude niveauEtude, Double tempsPartiel) throws EmployeException, EntityExistsException {
        logger.info("embaucheEmploye Embauche de l'employé : {} {} {} {} {} ",prenom,poste,niveauEtude, tempsPartiel);
        //Récupération du type d'employé à partir du poste
        String typeEmploye = poste.name().substring(0,1);
        //Récupération du dernier matricule...
        String lastMatricule = employeRepository.findLastMatricule();
        if(lastMatricule == null){
            logger.warn("Aucun employé trouvé, attribution du matricule initial {} ", Entreprise.MATRICULE_INITIAL);
        ...
        if(numeroMatricule >= 100000){
            ...
            logger.warn("Matricule 90000 depassé sur une liste de 100000");
        }
        ...
        if(employeRepository.findByMatricule(matricule) != null){
            logger.error("Matricule calculé :  {} ", matricule);
        ...
        logger.trace("Find de la méthode embaucheEmploye ");
    }
    /**
